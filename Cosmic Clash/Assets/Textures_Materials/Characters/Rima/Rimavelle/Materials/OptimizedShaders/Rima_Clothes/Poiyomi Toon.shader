Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/017e954c0f0738541b08f7fde1c43c4f"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void stylizedSpecular(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				{
					specMask1 += pow(specArea, exp2(lerp(11, 1, (0.261 /*_HighColor_Power*/)))) * (1.0 /*_Layer1Strength*/);
					specMask2 += pow(specArea, exp2(lerp(11, 1, (0.0 /*_Layer2Size*/)))) * (0.0 /*_Layer2Strength*/);
				}
				else
				{
					specMask1 += poiEdgeNonLinear(specArea, (1.0 - pow((0.261 /*_HighColor_Power*/), 5)), (0.0 /*_StylizedSpecularFeather*/)) * (1.0 /*_Layer1Strength*/);
				...
				#endif
				float finalSpecMask = min(min(specMask, poiLight.occlusion), attenuation) * (0.2 /*_StylizedSpecularStrength*/);
				switch((1.0 /*_Is_BlendAddToHiColor*/))
				{
					case 0:
					poiFragData.baseColor = lerp(poiFragData.baseColor, specularMap * poiThemeColor(poiMods, float4(0.8562991,0.02499199,0.03233241,1), (0.0 /*_HighColorThemeIndex*/)) * lerp(1, poiLight.directColor, (1.0 /*_UseLightColor*/)), finalSpecMask);
					break;
					case 1:
					poiLight.finalLightAdd += max(0, specularMap * poiThemeColor(poiMods, float4(0.8562991,0.02499199,0.03233241,1), (0.0 /*_HighColorThemeIndex*/)) * lerp(1, poiLight.directColor, (1.0 /*_UseLightColor*/)) * finalSpecMask);
					break;
					case 2:
					poiFragData.baseColor = lerp(poiFragData.baseColor, blendScreen(poiFragData.baseColor, specularMap * poiThemeColor(poiMods, float4(0.8562991,0.02499199,0.03233241,1), (0.0 /*_HighColorThemeIndex*/)) * lerp(1, poiLight.directColor, (1.0 /*_UseLightColor*/))), finalSpecMask);
					break;
					case 3:
					poiFragData.baseColor = lerp(poiFragData.baseColor, poiFragData.baseColor * specularMap * poiThemeColor(poiMods, float4(0.8562991,0.02499199,0.03233241,1), (0.0 /*_HighColorThemeIndex*/)) * lerp(1, poiLight.directColor, (1.0 /*_UseLightColor*/)), finalSpecMask);
					break;
				}
				float3 vSpecMask = 0;
				if (poiFragData.toggleVertexLights)
				{
					...
					for (int index = 0; index < 4; index++)
					{
						...
						if ((1.0 /*_Is_SpecularToHighColor*/))
						{
							vSpecMask = pow(specArea, exp2(lerp(11, 1, (0.261 /*_HighColor_Power*/)))) * (1.0 /*_Layer1Strength*/) * poiLight.vAttenuation[index];
							vSpecMask = max(vSpecMask, pow(specArea, exp2(lerp(11, 1, (0.0 /*_Layer2Size*/)))) * (0.0 /*_Layer2Strength*/) * poiLight.vAttenuation[index]);
						}
						else
						{
							vSpecMask = poiEdgeNonLinear(specArea, (1.0 - pow((0.261 /*_HighColor_Power*/), 5)), (0.0 /*_StylizedSpecularFeather*/)) * (1.0 /*_Layer1Strength*/) * poiLight.vAttenuation[index];
						...
						float finalSpecMask = min(min(vSpecMask, poiLight.occlusion), attenuation) * (0.2 /*_StylizedSpecularStrength*/);
						switch((1.0 /*_Is_BlendAddToHiColor*/))
						{
							case 0:
							poiFragData.baseColor = lerp(poiFragData.baseColor, specularMap * poiThemeColor(poiMods, float4(0.8562991,0.02499199,0.03233241,1), (0.0 /*_HighColorThemeIndex*/)) * lerp(1, poiLight.vColor[index], (1.0 /*_UseLightColor*/)), finalSpecMask);
							break;
							case 1:
							poiLight.finalLightAdd += max(0, specularMap * poiThemeColor(poiMods, float4(0.8562991,0.02499199,0.03233241,1), (0.0 /*_HighColorThemeIndex*/)) * lerp(1, poiLight.vColor[index], (1.0 /*_UseLightColor*/)) * finalSpecMask);
							break;
							case 2:
							poiFragData.baseColor = lerp(poiFragData.baseColor, blendScreen(poiFragData.baseColor, specularMap * poiThemeColor(poiMods, float4(0.8562991,0.02499199,0.03233241,1), (0.0 /*_HighColorThemeIndex*/)) * lerp(1, poiLight.vColor[index], (1.0 /*_UseLightColor*/))), finalSpecMask);
							break;
							case 3:
							poiFragData.baseColor = lerp(poiFragData.baseColor, poiFragData.baseColor * specularMap * poiThemeColor(poiMods, float4(0.8562991,0.02499199,0.03233241,1), (0.0 /*_HighColorThemeIndex*/)) * lerp(1, poiLight.vColor[index], (1.0 /*_UseLightColor*/)), finalSpecMask);
							break;
						}
					}
					#endif
