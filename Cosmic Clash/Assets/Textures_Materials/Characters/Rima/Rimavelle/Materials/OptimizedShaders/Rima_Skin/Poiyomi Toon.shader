Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/42434b249abf44f49b7999056151d6cc"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			)
			{
				...
				{
					distanceOffset *= lerp(1.0, clamp((distance(_WorldSpaceCameraPos, mul(unity_ObjectToWorld, o.localPos).xyz)), 0.0f, (7.0 /*_OutlinesMaxDistance*/)), (0.0 /*_OutlineFixWidth*/));
				}
			...
			void stylizedSpecular(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				specularMask = saturate(specularMask + (1.0 /*_Tweak_HighColorMaskLevel*/));
				...
				{
					case 0:
					poiFragData.baseColor = lerp(poiFragData.baseColor, specularMap * poiThemeColor(poiMods, float4(0.4055364,0.6521621,0.673178,1), (0.0 /*_HighColorThemeIndex*/)) * lerp(1, poiLight.directColor, (1.0 /*_UseLightColor*/)), finalSpecMask);
					break;
					case 1:
					poiLight.finalLightAdd += max(0, specularMap * poiThemeColor(poiMods, float4(0.4055364,0.6521621,0.673178,1), (0.0 /*_HighColorThemeIndex*/)) * lerp(1, poiLight.directColor, (1.0 /*_UseLightColor*/)) * finalSpecMask);
					break;
					case 2:
					poiFragData.baseColor = lerp(poiFragData.baseColor, blendScreen(poiFragData.baseColor, specularMap * poiThemeColor(poiMods, float4(0.4055364,0.6521621,0.673178,1), (0.0 /*_HighColorThemeIndex*/)) * lerp(1, poiLight.directColor, (1.0 /*_UseLightColor*/))), finalSpecMask);
					break;
					case 3:
					poiFragData.baseColor = lerp(poiFragData.baseColor, poiFragData.baseColor * specularMap * poiThemeColor(poiMods, float4(0.4055364,0.6521621,0.673178,1), (0.0 /*_HighColorThemeIndex*/)) * lerp(1, poiLight.directColor, (1.0 /*_UseLightColor*/)), finalSpecMask);
					break;
				}
				float3 vSpecMask = 0;
				if (poiFragData.toggleVertexLights)
				{
					...
					for (int index = 0; index < 4; index++)
					{
						...
						{
							case 0:
							poiFragData.baseColor = lerp(poiFragData.baseColor, specularMap * poiThemeColor(poiMods, float4(0.4055364,0.6521621,0.673178,1), (0.0 /*_HighColorThemeIndex*/)) * lerp(1, poiLight.vColor[index], (1.0 /*_UseLightColor*/)), finalSpecMask);
							break;
							case 1:
							poiLight.finalLightAdd += max(0, specularMap * poiThemeColor(poiMods, float4(0.4055364,0.6521621,0.673178,1), (0.0 /*_HighColorThemeIndex*/)) * lerp(1, poiLight.vColor[index], (1.0 /*_UseLightColor*/)) * finalSpecMask);
							break;
							case 2:
							poiFragData.baseColor = lerp(poiFragData.baseColor, blendScreen(poiFragData.baseColor, specularMap * poiThemeColor(poiMods, float4(0.4055364,0.6521621,0.673178,1), (0.0 /*_HighColorThemeIndex*/)) * lerp(1, poiLight.vColor[index], (1.0 /*_UseLightColor*/))), finalSpecMask);
							break;
							case 3:
							poiFragData.baseColor = lerp(poiFragData.baseColor, poiFragData.baseColor * specularMap * poiThemeColor(poiMods, float4(0.4055364,0.6521621,0.673178,1), (0.0 /*_HighColorThemeIndex*/)) * lerp(1, poiLight.vColor[index], (1.0 /*_UseLightColor*/)), finalSpecMask);
							break;
						}
					}
					#endif
